...
class MusicPlayer {
    constructor(
            ...
            songObjArr: [
                {
                    title: "刀剑神域",  // 歌曲名
                    author: "早见沙织",   // 歌手
                    imgSrc: "./images/img1.jpg", // 图片路径
                    url: "./Music/01.mp3", // 音频路径
                },
                {
                    title: "Swordland",
                    author: "陈小春",
                    imgSrc: "./images/QQ.png",
                    url: "./Music/Swordland.mp3",
                },
                {
                    title: "Lemon Tree",
        ...
        this._songObjArr = data.songObjArr; // 将数组赋值给this._songObjArr
        ...
        this._musicPlayerEntity.addComp(
            new MusicImgComp({ // 发现在这里：将它作为一个数组，遍历其中的元素进行操作，如果不是数组，就会发生错误
        ...
        this._musicPlayerEntity.addComp(
            new MusicComp({
                mUrlArr: Array.from(this._songObjArr, item => item.url), // 这里也是作为数组使用
        ...
        if (this._startTime === null) {
            ...
            let v =
                value < 0
                    ...
                    : value >= this._songObjArr.length // 这里也是
                        ? 0
                        : value;
