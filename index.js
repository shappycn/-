...
var endTimeSpan = document.getElementById("totalTimeOfMusic");
  ...
  audio.addEventListener("loadedmetadata", function() {
    ...
    endTimeSpan.textContent = formattedTime;
  });
...
//     // 当鼠标悬停在 span 上时触发的操作
//     console.error("鼠标悬停在 span 上");
//     // 可以在这里执行其他逻辑或修改样式等
//   });

//   span.addEventListener("mouseout", function() {
//     // 当鼠标离开 span 时触发的操作
//     console.log("鼠标离开 span");
//     // 可以在这里执行其他逻辑或修改样式等
//   });
// 音乐播放器
class MusicPlayer {
    constructor(
        data = {
            // 歌曲信息在这里修改
            // 第一个错误：你是不是不太认识json？
            // 看看左边的文件：显然songObjArr应该是一个数组类型
            songObjArr: [ // 你怎么平白无故的就把它的括号给删了
                {
                    title: "刀剑神域",
                    author: "早见沙织",
